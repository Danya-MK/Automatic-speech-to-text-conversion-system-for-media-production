...
Система автоматического распознавания русской речи на базе **Whisper Large v3** с LoRA-дообучением, постобработкой текста и REST API. Разработана в рамках дипломной работы по специальности «Инженерия искусственного интелекта».
